local Demo = { function (s) K.sSpk(s, "Narrator", "Hey there and welcome to my VN frameworks's tech demo!") end,
    function (s) K.sBgm(s, "Generic_Jazz.mp3", true) end,
    ...
    function (s) if (K.gFlg(s, "Loop") == 1) then K.sTxt(s, "Oh, that means it's your first time! Hello!") else K.sTxt(s, "It's nice to see you again!") end end,
    ...
    function (s) K.aSpr(s, "Generic", "Default", 800, "Stage Left", 30) end,
    function (s) K.sTxt(s, "And zoom in on them...") end,
    function (s) K.tSpr(s, "Generic", "Zoom", 2, 30) end,
    function (s) K.sTxt(s, "Jitter them around!") end,
    function (s) K.sCha(s, "Generic", "Jitter_Everything", 1, "Animation") end,
    function (s) K.sCha(s, "Generic", "Jitter_Everything", 10, "Animation") end,
    function (s) K.sCha(s, "Generic", "Jitter_Everything", 100, "Animation") end,
    ...
    function (s) K.sCha(s, "Generic", "Happy") K.sBgm(s, "Generic_Lighthearted.mp3", true) end,
    function (s) K.sTxt(s, "And sad! ;~;") end,
    function (s) K.sCha(s, "Generic", "Sad") end,
    function (s) K.sTxt(s, "And then zoom back out...") end,
    function (s) K.tSpr(s, "Generic", "Zoom", 0.5, 30) end,
    function (s) K.sTxt(s, "Let's slide the character along the X axis...") end,
    function (s) K.sFlg(s, "Original Position", K.mCha(s, "Generic", 1000, nil, 20)) K.sBgm(s, "Generic_Lighthearted.mp3", true) end,
    ...
    function (s) local x = K.gFlg(scene, "Original Position")[1] local y = K.gFlg(scene, "Original Position")[2] K.mCha(s, "Generic", x, y, 20, true) end,
    function (s) K.sTxt(s, "Oh and we can flip too!") end,
    function (s) K.tSpr(s, "Generic", "Flip", nil, 0) end,
    function (s) K.sTxt(s, "And then remove it!") end,
    function (s) K.rSpr(s, "Generic", "Fade Out", 10) end,
    function (s) K.aSpr(s, "Generic", "Happy", 640, "Stage Right", 10) end,
    function (s) K.sTxt(s, "Or not!") end,
    function (s) K.rSpr(s, "Generic", "Stage Left", 10) end,
    ...
    function (s) s.Containers[K.gTbx(s)].Elements[4].Shader._type = "Fade_Out" s.Containers[K.gTbx(s)].Elements[4].Shader._frame = 0 s.Containers[K.gTbx(s)].Elements[4].Shader._modifier = 10 end,
    ...
    function (s) local element = Kii.Element.create(Kii.Elements["Demo_ExitButton"]) element.Shader._type = "Fade_In" element.Shader._frame = 0 element.Shader._modifier = 25 Kii.Container.addElement(s.Containers[K.gTbx(s)], element) end,
